            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route ('category') }}">Catagory List</a></li>
							<li><a href="{{ route ('subcategory') }}">Sub Catagory List</a></li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Producty</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route ('add.product')}}">Add Producty</a></li>
							<li><a href="{{ route ('product.list')}}">Product List</a></li>
							<li><a href="{{ route ('add.color.size')}}">Add size & color</a></li>
                        </ul>
                    </li>
